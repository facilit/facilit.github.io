...
<div style="background-color:#FFF9C4; padding:20px;">
  <p>⚠️Atenção para este detalhe super importante: A pesquisa deve ser feita no ano onde seu objetivo principal foi criado e no nível de informação correto, caso contrário a entidade pesquisada não será encontrada, ok?</p>
